...
def test_get_mac_os_edition():
    ...
    assert _get_mac_os_edition("15") == "Sequoia"
    assert _get_mac_os_edition("26") == "Tahoe"
    assert _get_mac_os_edition("26.1") == "Tahoe"
    assert _get_mac_os_edition("27") == "macOS"
    assert _get_mac_os_edition("27.0.1") == "macOS"
    assert _get_mac_os_edition("not-a-version") == "--"
